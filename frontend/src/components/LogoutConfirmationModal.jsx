...
<div className="w-full max-w-md rounded-[32px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f1420] p-6 shadow-2xl shadow-slate-950/40 transition-colors duration-200">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Log out of workspace?</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="rounded-[28px] border border-gray-200 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-900/80 p-5 space-y-4">
          <div className="flex items-start gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-2xl bg-rose-500/15 text-rose-500 dark:text-rose-400 flex-shrink-0">
              <LogOut className="w-5 h-5" />
            </div>
            <div>
              <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">You'll be locked out of the workspace</p>
          ...
          <div className="flex items-start gap-3 rounded-2xl border border-emerald-800/40 bg-emerald-100 dark:bg-emerald-950/30 px-4 py-3">
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <button
            type="button"
            onClick={onClose}
            className="rounded-3xl bg-slate-100 dark:bg-slate-900 px-4 py-3 text-sm font-semibold text-slate-700 dark:text-slate-200 border border-gray-200 dark:border-slate-800 hover:bg-slate-200 dark:hover:bg-slate-800 transition duration-200"
          >
            Cancel
          </button>
          <button
